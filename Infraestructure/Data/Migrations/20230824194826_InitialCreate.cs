            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StockMin = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    StockMax = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    Stock = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    ValorVenta = table.Column<double>(type: "double", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombrePersona = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FechaNac = table.Column<DateOnly>(type: "date", maxLength: 50, nullable: false),
